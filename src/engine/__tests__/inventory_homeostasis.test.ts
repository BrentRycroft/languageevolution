...
describe("Phase 27.1 — full-simulation inventory convergence", () => {
  // Phase 29 Tranche 7g: trimmed 200→100 gens to fit the CI budget.
  // 100 gens is enough for the homeostatic regime to engage (English
  // hits tier-3 cap of ~40 phonemes by gen 50) and demonstrate
  // boundedness; the prior 200-gen run took 75s alone.
  it("English preset over 100 gens keeps leaf inventories bounded (no runaway growth)", () => {
