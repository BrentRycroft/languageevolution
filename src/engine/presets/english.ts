...
const LEXICON: Lexicon = {
  ...
  yes: ["j", "ɛ", "s"],
  no: ["n", "o"],
  computer: ["k", "ə", "m", "p", "j", "uː", "t", "ə", "ɹ"],
  phone: ["f", "o", "n"],
  school: ["s", "k", "uː", "l"],
  government: ["g", "ʌ", "v", "ə", "ɹ", "n", "m", "ə", "n", "t"],
  ...
  machine: ["m", "ə", "ʃ", "iː", "n"],
  electricity: ["ə", "l", "ɛ", "k", "t", "ɹ", "ɪ", "s", "ə", "t", "i"],
  car: ["k", "a", "ɹ"],
  train: ["t", "ɹ", "e", "j", "n"],
  plane: ["p", "l", "e", "j", "n"],
  ...
  world: ["w", "ə", "ɹ", "l", "d"],
  planet: ["p", "l", "æ", "n", "ə", "t"],
  future: ["f", "j", "uː", "tʃ", "ə", "ɹ"],
  history: ["h", "ɪ", "s", "t", "ə", "ɹ", "i"],
  language: ["l", "æ", "ŋ", "g", "w", "ə", "dʒ"],
  culture: ["k", "ʌ", "l", "tʃ", "ə", "ɹ"],
  idea: ["a", "j", "d", "iː", "ə"],
  problem: ["p", "ɹ", "a", "b", "l", "ə", "m"],
  ...
  month: ["m", "ʌ", "n", "θ"],
  today: ["t", "ə", "d", "e", "j"],
  yesterday: ["j", "ɛ", "s", "t", "ə", "ɹ", "d", "e", "j"],
  tomorrow: ["t", "ə", "m", "ɔ", "ɹ", "o"],
  bed: ["b", "ɛ", "d"],
  table: ["t", "e", "j", "b", "ə", "l"],
  chair: ["tʃ", "ɛ", "ɹ"],
  room: ["ɹ", "uː", "m"],
...
const SUPPLETION: NonNullable<import("../types").Language["suppletion"]> = {
  ...
  drink: { "verb.tense.past": ["d", "ɹ", "æ", "ŋ", "k"] },
  sing: { "verb.tense.past": ["s", "æ", "ŋ"] },
  run: { "verb.tense.past": ["ɹ", "æ", "n"] },
  find: { "verb.tense.past": ["f", "a", "w", "n", "d"] },
  think: { "verb.tense.past": ["θ", "ɔ", "t"] },
  bring: { "verb.tense.past": ["b", "ɹ", "ɔ", "t"] },
  ...
  good: { "adj.degree.cmp": ["b", "ɛ", "t", "ə", "ɹ"], "adj.degree.sup": ["b", "ɛ", "s", "t"] },
  bad: { "adj.degree.cmp": ["w", "ə", "ɹ", "s"], "adj.degree.sup": ["w", "ə", "ɹ", "s", "t"] },
};
...
const MORPHOLOGY: Morphology = {
  paradigms: {
    ...
    "adj.degree.cmp": { affix: ["ə", "ɹ"], position: "suffix", category: "adj.degree.cmp" },
...
export function presetEnglish(): SimulationConfig {
  ...
  return {
    ...
    // Phase 48 T11: English's rhotic is the alveolar approximant ɹ
    // (not the trill r). The validator flags raw `r` in the lexicon
    // as an IPA error.
    rhoticApproximant: true,
    preset: "english",
  };
}
